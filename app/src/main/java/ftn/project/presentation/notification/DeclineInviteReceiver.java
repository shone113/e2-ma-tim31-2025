...
import ftn.project.domain.worker.DeclineInviteWorker;

public class DeclineInviteReceiver extends BroadcastReceiver {
    @Override public void onReceive(Context ctx, Intent i) {
        String inviteId = i.getStringExtra("inviteId");
        int nid = i.getIntExtra("notificationId", 0);

        OneTimeWorkRequest w = new OneTimeWorkRequest.Builder(DeclineInviteWorker.class)
